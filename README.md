...
- [ ] Explain what a token is used for.
      Answer: A token is something that we get back from our API that we connect to. It is used for authenticating on your local machine so your personal information won't be as easily accessible for hackers.
- [ ] What steps can you take in your web apps to keep your data secure?
      Answer: We can make certain parts of our app inaccessible without the proper authentication.
- [ ] Describe how web servers work.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      Answer: The POST method can create, the GET can read, the PUT/PATCH can update and DELETE can delete.
